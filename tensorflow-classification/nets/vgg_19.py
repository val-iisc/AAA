...
def model(image, weights, biases, keep_prob=1.0):
    ...
    with tf.name_scope("conv3"):
        ...
        layers['conv3_4'] = conv_layer(layers['conv3_3'], weights['conv3_4'], biases['conv3_4'])
    ...
    with tf.name_scope("conv4"):
        ...
        layers['conv4_4'] = conv_layer(layers['conv4_3'], weights['conv4_4'], biases['conv4_4'])
    ...
    with tf.name_scope("conv5"):
        ...
        layers['conv5_4'] = conv_layer(layers['conv5_3'], weights['conv5_4'], biases['conv5_4'])
...
def vgg19(input):
    ...
    net = np.load(global_path + 'vgg19.npy').item()
    weights = {}
    biases = {}
